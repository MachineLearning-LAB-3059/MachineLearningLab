...
class LabeledInput:
    def __init__(self, file_name):
        ...
        self.input_dimension = len(self.input_vectors_column_major)
    ...
    def get_input_vector_row_major(self, k):
        return self.input_vectors_row_major[k]

    def get_all_outputs(self):
        return self.output_vector

    def get_all_outputs_column_major(self):
        res = np.array(self.get_all_outputs())[np.newaxis]
        return res.T
...
if __name__ == '__main__':
    data = LabeledInput('data.csv')

    print(data.get_all_outputs_column_major())
